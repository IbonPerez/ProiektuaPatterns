...
//			jContentPane.add(getBoton3());
			...
			JButton btnTablemaite = new JButton(ResourceBundle.getBundle("Etiquetas").getString("UserGUI.btnTablemaite.text")); //$NON-NLS-1$ //$NON-NLS-2$
			btnTablemaite.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					try {
						TableMaiteGUI frame = new TableMaiteGUI();
						frame.setVisible(true);
					} catch (Exception ex) {
						JOptionPane.showMessageDialog(null, "Arazo bat gertatu da.");
					}
			...
			btnTablemaite.setBounds(282, 221, 85, 21);
			jContentPane.add(btnTablemaite);
